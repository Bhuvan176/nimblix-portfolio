        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative w-full h-96 lg:h-[500px]">
              ...
              {/* Data Analytics - Top Left */}
              <motion.div
                animate={{ y: [15, -5, 15] }}
                transition={{ duration: 4, repeat: Infinity, delay: 0.5 }}
                className="absolute top-2 left-60 bg-white p-6 rounded-xl shadow-xl border border-gray-100"
              >
              ...
              {/* Cloud Solutions - Center Right */}
              <motion.div
                animate={{ y: [5, -15, 5] }}
                transition={{ duration: 4, repeat: Infinity, delay: 2.5 }}
                className="absolute bottom-1 right-0 bg-white p-6 rounded-xl shadow-xl border border-gray-100"
              >
                <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-3">
                  <span className="text-blue-600 font-bold">CLOUD</span>
                </div>
